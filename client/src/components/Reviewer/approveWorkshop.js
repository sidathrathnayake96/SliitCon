...
/**Defining the initial state of the workshop which has to be approved */
const initialState = {
    workshopTopic: '',
    conference: '',
    email: '',
...
export default class approveWorkshop extends Component {
    ...
    /**This method is to retrieve a work shop which is to be approved by the reviewer  */
    componentDidMount() {
    ...
    /**This is to set the state of the work shops attributes which are to be approved */
    onChange(e){
    ...
    /**This method is to invoke the insert funcitonality(approve) of the work shops which will be sent to the work shops */
    onSubmit(e) {
        e.preventDefault();
        let approveWorkSHop = {
        ...
        axios.put(`http://localhost:5000/workshop/update/approve/${this.props.match.params.workshopTopic}`, approveWorkSHop)
        .then(response => {
            window.location = '/get-allWorkshops/'
            alert('This Workshop Is Approved')
          })
          .catch(error => {
        ...
        axios.post('http://localhost:5000/workshopNotification/createAccept', approveWorkSHop1)
        .then(response => {
            window.location = '/get-allWorkshops/'
            //alert('This Workshop Is Approved')
          })
            ...
            <div>
                ...
                <div className="container">
                    <div className="view-account">  
                        ...
                        <h1 style={{textAlign:'center', textDecoration:'underline'}}>Approve This Workshop</h1>
